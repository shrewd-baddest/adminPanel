...
try {
  ...
  return (
    <div className='addProduct'>
        ...
        <h1><BriefcaseIcon  className='inline h-6 w-6'/>Add New Staff  </h1>
       <div className='product-right-bar'>
        <h4 className='draft'><NewspaperIcon className='inline h-6 w-6'/> save Draf</h4>
        <button onClick={handleSubmit} className='addproduct-button'><CheckIcon className='inline h-6 w-6'/>Add Staff</button> 
        </div>
        </div>
